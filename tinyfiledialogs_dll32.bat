...
gcc -ansi -std=c89 -pedantic -Wstrict-prototypes -Wall -o hello.exe hello.c tinyfiledialogs32.lib

rem gcc -ansi -std=gnu89 -pedantic -Wstrict-prototypes -Wall -c tinyfiledialogs.c
...
rem gcc -ansi -std=c89 -pedantic -Wstrict-prototypes -Wall -o hello.exe hello.c tinyfiledialogs32.lib
