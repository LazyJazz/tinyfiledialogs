gcc -ansi -std=gnu89 -pedantic -Wstrict-prototypes -c tinyfiledialogs.c
...
gcc -ansi -std=c89 -pedantic -Wstrict-prototypes -o hello.exe hello.c tinyfiledialogs32.lib

rem gcc -ansi -std=gnu89 -pedantic -Wstrict-prototypes -c tinyfiledialogs.c
...
rem gcc -ansi -std=c89 -pedantic -Wstrict-prototypes -o hello.exe hello.c tinyfiledialogs32.lib
