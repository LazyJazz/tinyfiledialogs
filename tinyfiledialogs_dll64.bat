\mingw-w64\mingw64\bin\gcc -ansi -std=c89 -pedantic -Wstrict-prototypes -m64 -c tinyfiledialogs.c
...
\mingw-w64\mingw64\bin\gcc -ansi -std=c89 -pedantic -Wstrict-prototypes -m64 -o hello.exe hello.c tinyfiledialogs64.lib
